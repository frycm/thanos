...
func NewRemotePlanExecutor(logger log.Logger, bkt objstore.Bucket, sched *Scheduler, dedupReplicaLabels []string, deletableChecker compact.BlockDeletableChecker) *RemotePlanExecutor {
